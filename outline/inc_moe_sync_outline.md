...
### 4.3 Readiness Skew in Practice
...
| 并发 | 单机 1n8 | 跨机 2n4 |
|---:|---:|---:|
| 1 | (9.26 ± 0.15)% | (19.39 ± 3.77)% |
| 2 | (10.20 ± 0.77)% | (18.10 ± 1.30)% |
| 4 | (10.41 ± 0.34)% | (18.31 ± 0.88)% |
| 8 | (10.95 ± 0.39)% | (19.88 ± 0.45)% |
| 16 | (14.91 ± 0.28)% | (18.73 ± 0.26)% |
| 32 | (12.18 ± 0.67)% | (17.66 ± 0.20)% |
| 64 | (9.33 ± 0.12)% | (16.72 ± 0.10)% |
| 128 | (7.94 ± 0.15)% | (15.19 ± 0.05)% |
| 256 | (7.61 ± 0.32)% | (14.22 ± 0.05)% |

这里的占比是完整 GPU step 内 48 次 Dispatch + 48 次 Combine 的累计 pre-barrier 时间。C1 是低负载锚点，每个窗口只有一个 active rank；跨机 C8 在该路由样本中有七个 active ranks；C16 之后两条曲线均为八个 active ranks。三个 client 窗口复用同一 server 实例。
