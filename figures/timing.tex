...
\node[paneltitle] at (.1,.15) {(a) Aligned ranks: endpoint exchanges};
...
\node[paneltitle] at (.1,.15) {(b) Aligned ranks: \sys{} overlap};
...
\node[paneltitle] at (.1,.15) {(c) Skewed ranks: endpoint exchanges};
\node at (1.1,.65) {Rank 0}; \node at (5.7,.65) {Rank 1};
...
\node[paneltitle] at (.1,.15) {(d) Skewed ranks: bounded staging};
\node at (.8,.65) {Rank 0}; \node at (3.6,.65) {\sys{}}; \node at (6.4,.65) {Rank 1};
