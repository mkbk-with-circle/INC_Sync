...
\node[smalllabel] at (3.4,3.94) {post-barrier exchange};
...
\node[anchor=west] at (.4,4.02) {No extra endpoint exchange for DONE.};
\end{scope}
...
\node[smalllabel,align=center] at (3.4,4.15) {Pre- and post-barrier signals\\traverse between endpoints};
\end{scope}
